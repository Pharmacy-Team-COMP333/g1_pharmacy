...
public class EmployeeController {
	...
	private void updateHourPrice(int id2, Double newValue) {
	    try {
	        Connector.a.connectDB();
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("UPDATE hourly_employee SET hour_price = ? WHERE id = ?");
	        stmt.setDouble(1, newValue);
	        stmt.setInt(2, id2);
	        stmt.executeUpdate();
	        stmt.close();
	...
	private void updateHourWork(int id2, double newValue) {
	    try {
	        Connector.a.connectDB();
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("UPDATE hourly_employee SET work_hours = ? WHERE id = ?");
	        stmt.setDouble(1, newValue);
	        stmt.setInt(2, id2);
	        stmt.executeUpdate();
	        stmt.close();
	...
	public void updatePass(int ID_num, String newValue) {
	    try {
	        Connector.a.connectDB();
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("UPDATE employee SET emp_password = ? WHERE id = ?");
	...
	public void updateName(int ID_num, String name) {
	    try {
	        Connector.a.connectDB();
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("UPDATE employee SET employee_name = ? WHERE id = ?");
	...
	public void updateBDate(int ID_num, String date) {
	    try {
	        ...
	        Connector.a.connectDB();
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("UPDATE employee SET birthday = ? WHERE id = ?");
	...
	public void updateDateE(int ID_num, String date) {
	    try {
	        ...
	        Connector.a.connectDB();
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("UPDATE employee SET date_of_employment = ? WHERE id = ?");
	        stmt.setDate(1, sqlDate);
	        stmt.setInt(2, ID_num);
	        stmt.executeUpdate();
	        stmt.close();
...
//			initialize();
	...
	private void deleteRow(int id) {
	    try {
	        ...
	        // Delete associated records from bill table
	        PreparedStatement stmt = Connector.a.connectDB().prepareStatement("DELETE FROM bill WHERE orderID IN (SELECT orderID FROM order_table WHERE employeeID = ?)");
	        stmt.setInt(1, id);
	        stmt.executeUpdate();
	        stmt.close();

	        // Delete associated records from order_table
	        stmt = Connector.a.connectDB().prepareStatement("DELETE FROM order_table WHERE employeeID = ?");
	        stmt.setInt(1, id);
	        stmt.executeUpdate();
	        stmt.close();

	        // Delete the employee record
	        stmt = Connector.a.connectDB().prepareStatement("DELETE FROM employee WHERE id = ?");
	        stmt.setInt(1, id);
	        stmt.executeUpdate();
	        stmt.close();
